...
export const CardOfGoodsDesktop = (props: PropsType) => {
    ...
    <div className="main__main-box">
      <div className="card-of-goods">
        ...
        <div className="card-of-goods__content goods-content">
          ...
          <ul className="goods-content__promo">
            <li>
              <img src={layout_icons_ico_graph_svg} alt="ico" />
            </li>
            <li className="goods-content__promo-action">
              При покупке от 10 000 &#8376; бесплатная доставка по Кокчетаву и
              области
            </li>
            <li className="goods-content__promo-download">
              Прайс лист{" "}
          ...
          <ul className="goods-content__info">
            ...
            <li>
              Тип ухода: <strong>{props.typesOfCareString}</strong>
            </li>
          </ul>
